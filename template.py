...
Description: template module providing the Template class for querying remote LLM service
'''
...
class Template(object):
    ...
    Given a question and material, please create an instruction starting with "{verb_root}".
    ...
    '''
    input_gen_template = '''
    Given an instruction and material, please extract some related information from the material that can help to comply with the instruction
...
if __name__ == "__main__":
    ...
    f = {
            "question": 'Whether genetics increase the risk of diabetes?',
            "instruction": '''
    ...
    instruct_temp = Template.instruction_gen_template.format(**f)
    input_temp = Template.input_gen_template.format(**f)
    output_temp = Template.output_gen_template.format(**f)
    print(instruct_temp)
    print("="*100)
    print(input_temp)
    print("="*100)
